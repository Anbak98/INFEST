...
public static class PlayerManager
{
    ...
    private static List<TestPlayer> _tempSpawnedPlayers = new List<TestPlayer>();

    public static void UpdatePlayerConnections(NetworkRunner runner, Action<PlayerRef> spawnPlayer, Action<PlayerRef, TestPlayer> despawnPlayer)
    {
        ...
        {
            TestPlayer player = _tempSpawnedPlayers[i];
